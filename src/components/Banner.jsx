...
const Banner = () => {
  return (
    <>
      <br/>
      <div className="banner jumbotron jumbotron-fluid" style={{backgroundImage: "url(https://i.postimg.cc/rs6YnjYS/Normas-de-seguridad-de-mecanica-automotriz.jpg)", alignSelf: 'center', backgroundSize: 'cover', color: "white"}}>
